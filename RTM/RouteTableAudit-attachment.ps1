...
Set-AzAutomationVariable -ResourceGroupName "RG-PROD-IT-AUTOMATION-NE01" -AutomationAccountName "AUTOACC-PROD-IT-OPS" -Name "RouteTableReport" -Value $body -Encrypted $False
